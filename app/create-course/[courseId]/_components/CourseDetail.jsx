...
function CourseDetail({course}) {
  return (
    <div className='border p-6 rounded-xl shadow-sm mt-3 mb-24' >
        <div className='grid grid-cols-2 md:grid-cols-4' >
            <div className='flex gap-2'>
                {/* image */}
                <Image src={'/student.gif'}  alt = "rocket" width={50} height={50}  />
                <div className='mt-3'>
            ...
            <div className='flex gap-2'>
                {/* image */}
                <Image src={'/overdue.gif'}  alt = "rocket" width={50} height={50}  />
                <div className='mt-3'>
            ...
            <div className='flex gap-2'>
                {/* image */}
                <Image src={'/boss2.gif'}  alt = "rocket" width={50} height={50}  />
                <div className='mt-3'>
            ...
            <div className='flex gap-2'>
                {/* image */}
                <Image src={'/video.gif'}  alt = "rocket" width={50} height={50}  />
                <div className='mt-3'>
